...
func NewCustomerHandler(uu usecase.CustomerUsecase) *CustomerHandler {
	return &CustomerHandler{usecase: uu}
}
...
func (h *CustomerHandler) Create(c *gin.Context) {
	...
	res, err := h.usecase.CreateCustomer(tenantID.(string), &req)
	if err != nil {
...
func (h *CustomerHandler) Update(c *gin.Context) {
	...
	res, err := h.usecase.UpdateCustomer(id, tenantID.(string), &req)
	if err != nil {
...
func (h *CustomerHandler) Delete(c *gin.Context) {
	...
	err := h.usecase.DeleteCustomer(id, tenantID.(string))
	if err != nil {
...
func (h *CustomerHandler) List(c *gin.Context) {
	...
	customers, err := h.usecase.GetCustomers(tenantID.(string))
	if err != nil {
...
func (h *CustomerHandler) Get(c *gin.Context) {
	...
	customer, err := h.usecase.GetCustomerByID(id, tenantID.(string))
	if err != nil {
