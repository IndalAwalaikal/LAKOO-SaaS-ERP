...
func NewNotificationUsecase(p repository.ProductRepository, s repository.SaleRepository) NotificationUsecase {
...
func (u *notificationUsecase) GetNotifications(tenantID string) ([]dto.NotificationResponse, error) {
