...
func NewTenantUsecase(tr repository.TenantRepository, ur repository.UserRepository, redisCli *redis.Client, cfg *config.Config) TenantUsecase {
...
func (u *tenantUsecase) Register(req *dto.RegisterRequest) (*dto.RegisterResponse, error) {
...
func (u *tenantUsecase) Login(req *dto.LoginRequest) (*dto.LoginResponse, error) {
...
func (u *tenantUsecase) ForgotPassword(req *dto.ForgotPasswordRequest) error {
	user, err := u.userRepo.GetByEmail(req.Email)
	if err != nil || user == nil {
...
func (u *tenantUsecase) ResetPassword(req *dto.ResetPasswordRequest) error {
	ctx := context.Background()
...
func (u *tenantUsecase) UpdateProfile(tenantID string, userID string, req *dto.UpdateTenantRequest) error {
...
func (u *tenantUsecase) ChangePassword(userID string, req *dto.ChangePasswordRequest) error {
	user, err := u.userRepo.GetByID(userID)
	if err != nil || user == nil { return errors.New("user not found") }
...
func (u *tenantUsecase) ListStaff(tenantID string) ([]*dto.StaffMemberResponse, error) {
...
func (u *tenantUsecase) AddStaff(tenantID string, req *dto.AddStaffRequest) error {
...
func (u *tenantUsecase) RemoveStaff(tenantID string, userID string) error {
	user, err := u.userRepo.GetByID(userID)
	if err != nil || user == nil { return errors.New("user not found") }
